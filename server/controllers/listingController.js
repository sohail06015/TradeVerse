// controllers for adding listing to databases
...
export const markFeatured = async (req, res) => {
    try {
        ...
        // if it's already featured, clicking again un-features it
        if (existingListing.featured) {
            const listing = await prisma.listing.update({
                where: { id },
                data: { featured: false }
            })
            return res.json({ message: "Listing removed from featured", listing });
        }
