...
const MyListings = () => {
  ...
  const toggleStatus = async (listingId) =>{
   ...
   const deleteListing = async (listingId) =>{
       try{
        const confirm = window.confirm('Are you sure you want to delete this listing? if credential are changed, new credential will be sent to your email ');
        if(!confirm) return;
  ...
  return (
   ...
   md:items-center mb-8"
    ...
    py-2 rounded font-medium flex items-center space-x-2 mt-4 md:mt-0"
      ...
      {/* balance section */}
      <div
        className="flex flex-col sm:flex-row justify-between gap-4 xl:gap-20
       p-6 mb-10 bg-white rounded-xl border border-gray-200"
      >
        {[
          ...
          <div
           onClick={()=> item.label === "Available" && setShowWithdrawal(true)  }
            key={index}
            className="flex flex-1 items-center justify-between p-4 rounded-lg
      ...
      {userListings.length === 0 ? (
        <div
          className="bg-white rounded-lg border border-gray-200 p-16
            text-center"
        >
          <div
            className="w-16 h-16 bg-gray-200 rounded-full flex items-center
                    ...
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex items-center gap-2">
                        <div className="relative group">
                          ...
                          >
                            <div className="bg-white text-gray-600 text-xs rounded border border-gray-600 p-2 px-3 ">
