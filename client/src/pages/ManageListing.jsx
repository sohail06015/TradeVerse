...
const ManageListing = () => {
  ...
  // get listing data for edit 'id' is provided (edit mode)
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600 mt-2">
            {isEditing
              ...
              : "Create listing to display your account info"}
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8" >
             ...
             <Section title= 'Basic Information' >
                ...
                onChange={(v)=>handleInputChange('title',v)}  required={true} />
                 ...
                 <SelectField  label='platform *' options={platfrom} 
                 value={formData.platform}  onChange={(v) => handleInputChange('platform', v) }
                 required ={true} /> 
                ...
                onChange={(v)=>handleInputChange('username',v)}  required={true} />
                  ...
                  <SelectField  label='Niche/Category *' options={niches} 
                 value={formData.niche}  onChange={(v) => handleInputChange('niche', v) }
                 required ={true} /> 
             ...
             <Section title= 'Account Metrics' >
               ...
               <InputField  label ='Followers Count *' type='number' value={formData.followers_count}
                placeholder='e.g.,10000' 
                onChange={(v)=>handleInputChange('followers_count',v)}  required={true} />
              ...
              <InputField  label ='Primary Audience Country '  value={formData.country}
                ...
                <SelectField  label=' Primary Audience Age Range' options={ageRange} 
             ...
             <div className="flex justify-end gap-3 text-sm" >
               ...
               className="px-6 py-2 border border-gray-300 rounded-lg 
                hover:bg-gray-50 transition-colors "  > Cancel
               </button>
