             ...
             return (
              <div key={id} className='bg-white rounded-lg border border-gray-200
               ...
               <div className='flex flex-col gap-2 items-end' >
                    <button onClick={()=> setExpendedId((p)=>(p=== id ? null : id))  }  className='flex items-center gap-2 bg-white border 
                  ...
                  <div className='mt-4 md:mt-0 pt-4' >
                    <div className='space-y-2' >
                       {credential.updatedCredential.map((cred)=>(
                        <div key={cred.name} className='flex items-center justify-between gap-3
