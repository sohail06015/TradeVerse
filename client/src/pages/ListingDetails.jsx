...
const purchaseAccount = async () => {
  ...
  return listing ? (
    <div className="mx-auto min-h-screen px-6 md:px-16 lg:px-24 xl:px-32">
      ...
      >
        <ArrowLeftIcon className="size-4" /> Go to Previos Page
      </button>

      <div className="flex items-start max-md:flex-col gap-10">
        <div className="flex-1 max-md:w-full">
          {/* {top section} */}
          <div className="bg-white rounded-xl border-gray-200 p-6 mb-5">
          ...
          {images?.length > 0 && (
            <div
              className="bg-white rounded-xl border border-gray-200 mb-5
              overflow-hidden"
            >
              <div className="p-4">
          ...
          <div className="bg-white rounded-xl border border-gray-200 mb-5">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gao-4 p-4 text-center">
              <div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 mb-5">
            <div className="p-4 borer-b border-gray-100">
        ...
        {/* {sellet info and purchase option} */}
        <div
          className="bg-white min-w-full md:min-w-[370px] rounded-xl
           border border-gray-200 p-5 max-md:mb-10"
        >
          <h4 className="font-seminold text-gray-800 mb-4">
            {" "}
            Seller Information{" "}
          </h4>
          ...
          <button
            ...
            className="w-full bg-indigo-600 text-white py-2
              rounded-lg hover:bg-indigo-700 transition text-sm font-medium
          ...
          {listing.isCredentialChanged && (
            <button
              ...
              className="w-full mt-2 bg-purple-600 text-white py-2
              rounded-lg hover:bg-purple-700 transition text-sm font-medium
              flex items-center justify-center gap-2"
            >
