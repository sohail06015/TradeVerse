  ...
  return (
    <div className={` ${showFilterPhone ? "max-sm:fixed" : "max-sm:hidden"  }  
     ...
     <div  className='p-4 border-b border-gray-200' >
       ...
       <div className='flex items-center justify-between' >
          ...
          <div className='flex items-center gap-2' >
             <X onClick={onClearFilters}   className='size-6 text-gray-500 hover:text-gray-700
     ...
     <input  type="text" placeholder='search by username, platform, niche, etc.' 
        className='w-full text-sm px-3 py-2 border-gray-300
        ...
        <div>
            <button onClick={()=>toggleSection("platform") } className='flex items-center justify-between w-full mb-3' >
                <label className='text-sm font-medium text-shadow-gray-800' >Platform</label>
        ...
        <div>
            <button onClick={()=>toggleSection("price") } className='flex items-center justify-between w-full mb-3' >
                <label className='text-sm font-medium text-shadow-gray-800' >Price Range </label>
                <ChevronDown className= {`size-4 transition-transform 
        ...
        <div>
            <button onClick={()=>toggleSection("followers") } className='flex items-center justify-between w-full mb-3' >
                <label className='text-sm font-medium text-shadow-gray-800' > Minimum Followers </label>
                <ChevronDown className= {`size-4 transition-transform 
       ...
       {/* {niche filter} */}
         ...
         <div>
            <button onClick={()=>toggleSection("niche") } className='flex items-center justify-between w-full mb-3' >
                <label className='text-sm font-medium text-shadow-gray-800' > Niches </label>
                <ChevronDown className= {`size-4 transition-transform 
       ...
       <div>
            <button onClick={()=>toggleSection("status") } className='flex items-center justify-between w-full mb-3' >
                <label className='text-sm font-medium text-shadow-gray-800' > Account Status </label>
                <ChevronDown className= {`size-4 transition-transform 
