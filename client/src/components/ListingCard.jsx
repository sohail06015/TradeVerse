...
import { BadgeCheck, LineChart, MapPin, UsersIcon } from "lucide-react";
    ...
    >
      ...
      {listing.featured && (
        <>
          <p className="py-1" />
          <div
            className="absolute top-0 left-0 w-full bg-gradient-to-r
      ...
      <div className="p-5  pt-8">
        ...
        <div className="flex items-center gap-3 mb-3">
          ...
          {listing.verified && (
            <BadgeCheck
              className="text-green-500 ml-auto w-5
                     h-5 "
            />
          )}
        </div>
        {/* {stats} */}
        <div
          className="flex flex-wrap justify-between max-w-lg items-center gap-3
         my-5"
        >
          <div className="flex items-center text-sm text-gray-600">
            <UsersIcon className="size-6 mr-1 text-gray-400" />
        ...
        <div className="flex items-center justify-between ">
          ...
          <button
            ...
            className="px-7 py-3 bg-indigo-600 text-white text-sm
