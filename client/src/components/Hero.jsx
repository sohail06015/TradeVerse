  ...
  return (
    <> 
            ...
            <div className="relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-gray-800">              
                ...
                <p className="max-w-xl text-center text-base my-7">A secure marketplace to buy and sell Instagram, YouTube, Twitter, Telegram and more - fast, safe and 
                                hassle-free.</p>
                ...
                <form onSubmit={onSubmitHandler} className='w-full flex justify-center group'>
                    <label className='border border-gray-400 rounded-md p-1 flex items-center w-full max-w-md'>
                        <input onChange={e => setInput(e.target.value)} value={input} type="text" placeholder='Enter your account' className='pl-2 flex-1 outline-none' />
